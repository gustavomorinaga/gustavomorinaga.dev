...
<style lang="scss" global>
	section#cookie-consent {
		@apply card card-bordered card-compact fixed bottom-0 left-0 right-0 z-50 max-w-full border-x-0 border-b-0 bg-base-100/75 shadow-lg backdrop-blur-md backdrop-saturate-200 transition-all duration-300 ease-out md:bottom-20 md:left-8 md:max-w-sm md:border;
		...
		& .card-body {
			...
			& .card-actions {
				& .cta {
					@apply btn btn-primary btn-sm btn-block;
				}
			}
		}
	}
