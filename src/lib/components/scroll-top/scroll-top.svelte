...
<style lang="scss" global>
	#btn-scroll-top {
		@apply fixed z-40 right-0 md:right-8 bottom-44 btn rounded-l-full md:btn-circle text-shadow-md shadow-black opacity-0 outline outline-black pointer-events-none transition-opacity duration-300 ease-out;
