...
<style lang="scss" global>
	button#btn-scroll-top {
		@apply fixed z-30 right-0 md:right-8 bottom-44 btn rounded-l-full md:btn-circle opacity-0 shadow-lg pointer-events-none transition-opacity duration-300 ease-out;
