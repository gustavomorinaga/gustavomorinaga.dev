...
<style lang="scss" global>
	.notifications {
		...
		& .notification {
			@apply card card-bordered card-compact max-w-full border-x-0 border-b-0 bg-base-100/75 shadow-lg backdrop-blur-md backdrop-saturate-200 transition-all duration-300 ease-out md:max-w-sm md:border;
