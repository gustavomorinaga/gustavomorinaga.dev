export const IMAGES_WEBP = {
	avatar: (await import('./avatar.webp')).default,
	displacement: (await import('./texture-displacement.webp')).default,
	...
	previewHotCode: (await import('./preview-hotcode.webp')).default,
	profileCropped: (await import('./profile-cropped.webp')).default,
	profile: (await import('./profile.webp')).default,
	universe: (await import('./bg-universe.webp')).default
};
